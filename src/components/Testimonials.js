...
const Testimonials = (props) => {
  ...
  return (
    ...
    transition-all duration-700 hover:shadow-xl rounded-md'>
        ...
        <div className='flex text-3xl gap-3 text-violet-400 font-bold justify-center items-center mt-8'>
        ...
        px-10 py-2 rounded-md font-bold text-white text-lg'>Surprise Me</button>
        </div>
